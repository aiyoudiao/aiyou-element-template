...
export const TOYS_MANAGER_MENU_DIALOG = 'toys-menu-dialog'
export const TOYS_MANAGER_MENU_DIALOG_PATH = 'toys-menu-dialog'
export const TOYS_MANAGER_MENU_DIALOG_ZHCN = '菜单对话框'
