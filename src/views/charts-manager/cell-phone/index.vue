 ...
 * @LastEditTime: 2020-08-30 20:36:31
...
import CommonTable from '@/components/common-components/common-table'
import CommonLine from '@/components/common-components/common-line'
    ...
    data() {
        return {
            ...
            netPoliceDataConfig: {
                ...
                data: [
                    ['08-11 10:25', '08-12 03:21', 4, '设备[ZJ-RT-7206-CIP-P]10.1....'],
                ...
                chartData: {
                    ...
                    rows: [].concat(
                        [
                            ...
                            ['10:40', '12.38', '9.38', '36.00', '34'],
                            ['10:45', '7.92', '3.92', '27.00', '25'],
                            ['10:50', '17.62', '15.62', '43.00', '38'],
                            ['10:55', '10.07', '9.07', '26.00', '23'],
