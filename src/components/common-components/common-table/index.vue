...
<div class="common-table">
    ...
    <template v-if="isScroll">
        <!-- 可以自动滚动的表格 -->
        <dv-scroll-board :config="scrollBoardConfig" :style="getScrollTableHeight()" />
    </template>
    <template v-else>

        <!-- 带滚动条的普通表格 -->
        <el-table :data="tableData" :height="getTableHeight()" style="width: 100%" :stripe="false" :border="false" :highlight-current-row="false">
            <el-table-column v-for="items in columnData" :key="items" :label="items" :prop="items" align="center" :resizable="false">
            </el-table-column>
        </el-table>
